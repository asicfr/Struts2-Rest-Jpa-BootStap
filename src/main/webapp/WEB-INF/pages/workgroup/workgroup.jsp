...
<link href="<s:url value='/static/css/styles.css' includeParams='none'/>" rel="stylesheet" />
  ...
  <body>
    ...
    <div class="navbar navbar-fixed-top">
      <div class="navbar-inner">
        <div class="container">
          ...
          <a class="brand" href="#">Workgroup</a>
    ...
    <div class="container">
		...
		<s:form name="workgroupForm" action="workgroup" cssClass="well">  
		
			<s:textfield name="current.id"      		label="id" />
			<s:textfield name="current.name"      		label="name" />
			<s:textfield name="current.description"      		label="description" />
			<s:textfield name="current.creationDate"      		label="creationDate" />
