<%-- List screen for Synopsis entity      --%>
    ...
    <div class="navbar navbar-fixed-top">
      <div class="navbar-inner">
        <div class="container">
          ...
          <a class="brand" href="#">Synopsiss List</a>
    ...
    <div class="container">
		...
		<thead>
			<tr>
				...
				<th><s:property value="getText('current.synopsis')" /></th> 
				<th><a class="btn btn-info" href="<s:url value="/synopsis/clear/"/>">new</a></th> 
			</tr>
		</thead>
		<tbody>
			<s:iterator value="searchResult" >
				<tr>
					...
					<td><s:property value="synopsis" /></td>

				<td><a class="btn btn-info" href="<s:url value="/synopsis/load/%{bookId}"/>">edit</a> </td>
