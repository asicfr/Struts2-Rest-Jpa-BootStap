...
<link href="<s:url value='/static/css/styles.css' includeParams='none'/>" rel="stylesheet" />
  ...
  <body>
    ...
    <div class="navbar navbar-fixed-top">
      <div class="navbar-inner">
        <div class="container">
          ...
          <a class="brand" href="#">EmployeeGroup</a>
    ...
    <div class="container">
		...
		<s:form name="employeegroupForm" action="employeegroup" cssClass="well">  
		
		
				<s:textfield name="current.key.employeeCode"      		label="employeeCode" />
			
				<s:textfield name="current.key.groupId"      		label="groupId" />
			...
			<td colspan="2">
			 	...
			 	<input type="button" class="btn btn-info" value="Delete" onclick="directDelete('<s:property value="#attr.current.key.employeeCode" />', '<s:property value="#attr.current.key.groupId" />')" />
