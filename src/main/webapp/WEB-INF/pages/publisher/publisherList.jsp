...
<html lang="en">
  ...
  <body>
    ...
    <div class="navbar navbar-fixed-top">
      <div class="navbar-inner">
        <div class="container">
          ...
          <a class="brand" href="#">Publishers List</a>
    ...
    <div class="container">
		...
		<thead>
			<tr>
				...
				<th><s:property value="getText('current.contact')" /></th> 
				...
				<th><a class="btn btn-info" href="<s:url value="/publisher/clear/" />">new</a></th> 
			</tr>
		</thead>
		<tbody>
			<s:iterator value="searchResult" >
				...
				<td><a class="btn btn-info" href="<s:url value="/publisher/load/%{code}" />" >edit</a> </td>
	...
	<script type="text/javascript">
		...
		var urlBase = '<s:url action="publisher" includeParams="none" />';
		
		function changeActionAndsubmit(url) {
			document.publisherForm.action = urlBase + '/' + url;
