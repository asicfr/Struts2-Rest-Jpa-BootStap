...
<link href="<s:url value='/static/css/styles.css' includeParams='none'/>" rel="stylesheet" />
  ...
  <body>
    ...
    <div class="container">
		...
		<s:form name="publisherForm" action="publisher" cssClass="well">  
		
			<s:textfield name="current.code"      		label="code" />
			<s:textfield name="current.countryCode"      		label="countryCode" />
			<s:textfield name="current.name"      		label="name" />
			<s:textfield name="current.email"      		label="email" />
			<s:textfield name="current.contact"      		label="contact" />
