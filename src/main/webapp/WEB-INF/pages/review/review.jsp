  ...
  <body>
    ...
    <div class="container">
		...
		<s:form name="reviewForm" action="review" cssClass="well">  
				...
				<s:textfield name="current.key.customerCode"      		label="customerCode" />
			
				<s:textfield name="current.key.bookId"      		label="bookId" />
			
				<s:textfield name="current.reviewText"      		label="reviewText" />
			
				<s:textfield name="current.reviewNote"      		label="reviewNote" />
			
				<s:textfield name="current.creation"      		label="creation" />
			
				<s:textfield name="current.lastUpdate"      		label="lastUpdate" />
