...
<html lang="en">
  ...
  <body>
    ...
    <div class="container">
		...
		<thead>
			<tr>
				<th><s:property value="getText('customerCode')" /></th> 
				<th><s:property value="getText('bookId')" /></th> 
				<th><s:property value="getText('reviewText')" /></th> 
				<th><s:property value="getText('reviewNote')" /></th> 
				<th><s:property value="getText('creation')" /></th> 
				<th><s:property value="getText('lastUpdate')" /></th> 
