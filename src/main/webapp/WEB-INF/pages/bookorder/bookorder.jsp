  ...
  <body>
    ...
    <div class="container">
		...
		<s:form name="bookorderForm" action="bookorder" cssClass="well">  
			...
			<s:textfield name="current.shopCode"      		label="shopCode" />
			<s:textfield name="current.customerCode"      		label="customerCode" />
			<s:textfield name="current.employeeCode"      		label="employeeCode" />
			<s:textfield name="current.date"      		label="date" />
			<s:textfield name="current.state"      		label="state" />
